...
| **`grading-results`** | Exam Account Service | Kết quả, lỗi kỹ thuật, trả bài và cảnh báo nghiệp vụ | `UpdateProgress` |
...
1. **Khởi chạy hệ thống**: bật RabbitMQ, Central (`5177`), Engine (`5174`), Plagiarism (`5175`) và Notification (`5176`).
